...
<head>
    ...
    <link rel="stylesheet" href="assets/scss/paymain-wte.css" />
</head>
...
<header class="header bg-navy">
    ...
    <section class="bg-navy">
        <div class="checkout container">
            <div class="text-center checkout-title">
                Terima Kasih
                <br class="d-none d-lg-block" /> Tiket Anda telah  <span class="text-gradient-blue"> Dikonfirmasi </span>
            </div>
            ...
            <img src="<?php echo $event['image_co']; ?>" class="img-content" alt="Event Image">
                <div class="d-flex flex-column gap-3" style="margin-left: 50px;">
    ...
    <footer class="footer bg-navy">
        <div class="container">
            ...
            <div class="mt-2 d-flex flex-row flex-wrap footer-content align-items-baseline">
                <p class="paragraph">
